...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--lambda_id', type=float, default=5.0, help='weight for id loss')
        parser.add_argument('--use_ID', action='store_true', help='use id loss or not')

        parser.add_argument("--config", type=str, default="./palm-recognition/data/mbfn_public.py")
        parser.add_argument("--checkpoint", type=str, default="./palm-recognition/data/checkpoint-epoch26.pth")

        parser.add_argument('--use_L2', action='store_true', help='if two Ds share the weights or not')
